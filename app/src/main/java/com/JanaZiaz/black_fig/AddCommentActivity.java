...
public class AddCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comment=findViewById(R.id.categoryname);
    ...
    private void saveimage() {
        ...
        final StorageReference filepath = storageReference.child("img5" + id + ".jpg");
    ...
    private void saveprointodatabase() {
        ...
        objectHashMap.put("id", comment.getText().toString());
        objectHashMap.put("data", savedata);
        objectHashMap.put("time", savetime);


        objectHashMap.put("comment", comment.getText().toString());
