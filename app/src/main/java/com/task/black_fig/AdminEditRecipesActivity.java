...
import com.task.black_fig.Adapter.RecipesAdminAdapter;
import com.task.black_fig.Model.recipes;
...
public class AdminEditRecipesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_edit_recipes);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final android.app.Dialog dialog = new android.app.Dialog(AdminEditRecipesActivity.this);
                    ...
                    mDatabase.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists()){
                                ...
                                adapter = new RecipesAdminAdapter(getApplicationContext(), AdminEditRecipesActivity.this,name,img,idlist,time,ing,keys,"");
